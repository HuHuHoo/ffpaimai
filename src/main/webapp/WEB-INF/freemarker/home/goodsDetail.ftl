...
<div class="row clearfix">
    <div class="not_box clearfix">
        <dl class="x_4 clearfix" id="x_6">
            <dt><img src="${goods.image?if_exists}"
                     tppabs="${goods.image?if_exists}"></dt>
            <dd class="d_1">${goods.name?if_exists}</dd>
            <dd class="d_2">起拍价(RMB)：${goods.price?if_exists}<br>拍卖日期：${goods.tradeDate?if_exists}
                <br>状态：${goods.state?if_exists}</dd>
