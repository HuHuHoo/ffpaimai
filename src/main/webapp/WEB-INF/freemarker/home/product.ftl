...
<body>
    ...
    <div class="newtab">
        <div id="ib-main-wrapper" class="ib-main-wrapper">
            <div class="ib-main"><span class="idTabs" id="itab_2"><a href="#" rel="#locA" class="locOn"> 房地产</a><a
                    href="#" rel="#locB">字画 / 艺术品</a><a href="#" rel="#locC">汽车 </a><a href="#" rel="#locD">
                股权</a><a href="#" rel="#locE">无形资产 </a><a href="#" rel="#locF">其它</a></span>
        ...
        <div class="row" style="padding-bottom:50px;">
            <ul id="locA" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/product/realty/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
            <ul id="locB" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/product/art/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
            <ul id="locC" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/product/car/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
            <ul id="locD" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/product/interest/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
            <ul id="locE" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/product/invisibleAssets/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
            <ul id="locF" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/product/other/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
        </div>
    </div>
