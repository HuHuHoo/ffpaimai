...
<div class="newtab">
    ...
    <div class="row">
        <ul id="locA" class="loc">
            <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/content/index/news/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
        </ul>
    </div>
</div>
