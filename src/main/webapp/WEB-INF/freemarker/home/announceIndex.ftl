...
<#if announces?has_content>
    <#list announces as announce>
        <dl class="x_1 clearfix" <#if announce_index=1||announce_index=3> id="x_3"</#if>>
            <dt>${announce.name?if_exists}</dt>
            ...
            <dd class="d_2 clearfix">
                ...
                <span class="s_2">
                    <a href="${ctx}/home/announce/detail/${announce.id?c}/${recommend?c}/${fresh}"target="_top">详细&gt;&gt;</a>
                </span>
            </dd>
        </dl>
    </#list>
    ...
    <#if pre??>
        <p class="p_1">
            <a href="${ctx}/home/announce/index/${recommend?c}/${fresh}/${pre?c}" >&lt;&nbsp;上一页</a>
        </p>
    </#if>
    <#if after??>
        <p class="p_2">
            <a href="${ctx}/home/announce/index/${recommend?c}/${fresh}/${after?c}">下一页&nbsp;&gt;</a>
        </p>
    </#if>
    </div>
</div>
