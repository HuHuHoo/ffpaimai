    ...
    <#if images?has_content>
        <#list images as image>
            <div style="width: 100%;height: 405px">
                <a href="" target="_blank"><img src="${image.path?if_exists}"/></a>
            </div>
        </#list>
    </#if>
        ...
        <div class="i_content">
            ...
            <#if contents?has_content>
                <#list contents as content>
                    <#if (content_index=0)>
                        <dl>
                            <dt>
                                <a href="${ctx}/home/content/detail/${content.id?c}" target="_blank"><img
                                        src="${ctx}/static/images/news.jpg"></a>
                            </dt>
                            <dd class="d_1">
                                <a href="${ctx}/home/content/detail/${content.id?c}/news"
                                   target="_blank">${content.name?if_exists}</a>
                            </dd>
                            <dd class="d_2">
                                <a href="${ctx}/home/content/detail/${content.id?c}/news"
                                   target="_blank">${content.summary?if_exists}</a>
                            </dd>
                        </dl>
                    <#else>
                        <#if content_index =5>
            ...
            <div class="i_product">
                <div id="slider1_container"
                     style="position: relative; top: 0px; left: 0px; width: 809px; height: 160px; overflow: hidden;">
                    ...
                    <!-- Slides Container -->
                    <div u="slides"
                         style="cursor: move; position: absolute; left: 0px; top: 0px; width: 809px; height: 160px; overflow: hidden;">
                        ...
                        <#list goodsList as goods>
                            ...
                            <div>
                                <a href="${ctx}/home/goods/${goods.id?c}" style="height:160px;width:150px">
                                    <img u="image" src="${goods.image?if_exists}"
