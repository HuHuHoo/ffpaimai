...
<body>
    ...
    <div class="newtab">
        <div id="ib-main-wrapper" class="ib-main-wrapper">
            <div class="ib-main">
                <span class="idTabs">
                    <a href="#" rel="#locA" class="locOn">拍卖公告</a><a href="#" rel="#locB">拍品推荐</a><a href="#" rel="#locC">最新拍卖预告</a><a href="#" rel="#locD"> 经典回顾</a><a href="#" rel="#locE">行业动态</a></span>
        ...
        <div class="row" style="padding-bottom:50px;">
            <ul id="locA" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/announce/index/-1/-1/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
            <!--2-->
            <ul id="locB" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/announce/index/1/0/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
            <ul id="locC" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/announce/index/0/1/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
            <ul id="locD" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/content/index/classic/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
            <ul id="locE" class="loc">
                <iframe scrolling="no" frameborder="0" id="page" name="page" src="${ctx}/home/content/index/tend/<#if index??>${index?c}<#else>0</#if>" class="not_page" allowtransparency="true"></iframe>
            </ul>
        </div>
    </div>
