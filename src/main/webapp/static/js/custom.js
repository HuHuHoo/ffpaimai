...
jQuery(document).ready(function ($) {
	...
	// Scrollbars
	$("html").niceScroll({zindex:999,cursorborder:"",cursorborderradius:"2px",cursorcolor:"#bebebe",cursoropacitymin:1});
	function initNice() {
		if($(window).innerWidth() <= 1000) {
			$('html').niceScroll().remove();
		} else {
			$("html").niceScroll({zindex:999,cursorborder:"",cursorborderradius:"2px",cursorcolor:"#8c7862",cursoropacitymin:1});
		}
	}
