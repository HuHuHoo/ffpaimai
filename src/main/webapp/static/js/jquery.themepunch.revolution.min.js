...
function revslider_showDoubleJqueryError(e) {
    ...
    function S(e, n) {
        ...
        if (a.data("lazyload") != t && a.data("lazydone") != 1) {
            a.attr("src", u.find(".defaultimg").data("lazyload")),
            a.data("lazydone", 1);
            a.data("orgw", 0);
    ...
    function x(n, r) {
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            if (l == 12) if (r.ie9) {
                ...
                0)
            } else if (l == 15) if (r.ie9) x.transition({
                left: 0 - E + "px"
            },
            0);
            else x.transition({
            ...
            0);
            else if (l == 13) if (r.ie9) x.transition({
                top: S + "px"
            },
            0);
            else x.transition({
            ...
            0);
            else if (l == 14) if (r.ie9) x.transition({
                top: 0 - S + "px"
            },
            0);
            else x.transition({
        ...
        revolution: function(i) {
            ...
            return this.each(function() {
                ...
                if (!o.hasClass("revslider-initialised")) {
                    ...
                    o.find(".tp-scrollbelowslider").on("click",
                    function() {
                        var t = 0;
                        try {
